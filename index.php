...
$stmt = $pdo->query("SELECT * FROM lectures ORDER BY id DESC LIMIT 3");
$latestLectures = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>منصة المحاضرات - الرئيسية</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>منظومة تنظيم <br /><span class="highlight">المحاضرات والدروس الأكاديمية</span></h1>
            <p>منصتك الشاملة لمتابعة وتنظيم المحاضرات الأكاديمية وورش العمل بكل سهولة</p>
            <a href="lectures.php" class="btn btn-primary">📚 استكشف المحاضرات</a>
        </div>
    </section>
